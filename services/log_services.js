...
const printDateTime = () => {
  const dateOutput = new Date().toLocaleDateString();
  const TimeOutput = new Date().toLocaleTimeString();
...
export {
  printError, printReadInput, printDateTime, printWindSpeed, printTemp, printDesc,
};
